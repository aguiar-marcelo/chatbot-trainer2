  ...
  client.onMessage(async (message) => {
    if (message.isGroupMsg === false) {
      ...
      if (message.body === "1") {
        ...
        client.sendText(
          userId,
          "Para montar seu treino personalizado, me diga qual seu objetivo (exemplo: perder peso, ganhar massa muscular, definir o corpo)."
        );
      } else if (message.body === "3") {
        client.sendText(
          userId,
          "Para calcular seus macronutrientes, me informe primeiro seu peso (em kg). Exemplo: 70"
        );
        ...
        if (!isNaN(peso) && peso > 0) {
          ...
          client.sendText(
            userId,
            "Agora me informe sua altura (em metros). Exemplo: 1.75"
          );
        } else {
          client.sendText(
            userId,
            "Peso inválido. Por favor, digite um valor válido. Exemplo: 70"
          );
        }
        ...
        if (!isNaN(altura) && altura > 0) {
          ...
          client.sendText(
            userId,
            "Altura inválida. Por favor, digite um valor válido. Exemplo: 1.75"
          );
        }
        ...
        if (!isNaN(idade) && idade > 0) {
          ...
          client.sendText(
            userId,
            "Agora me informe seu sexo (Masculino ou Feminino)."
          );
        } else {
          client.sendText(
            userId,
            "Idade inválida. Por favor, digite um valor válido. Exemplo: 25"
          );
        }
        ...
        if (sexo === "masculino" || sexo === "feminino") {
          ...
          client.sendText(
            userId,
            "Qual seu objetivo? Digite 1 para ganhar massa muscular ou 2 para definir."
          );
        } else {
          client.sendText(
            userId,
            "Sexo inválido. Por favor, digite Masculino ou Feminino."
          );
        }
        ...
        if (objetivo === 1 || objetivo === 2) {
          ...
          client.sendText(
            userId,
            "Objetivo inválido. Digite 1 para ganhar massa muscular ou 2 para definir."
          );
        }
